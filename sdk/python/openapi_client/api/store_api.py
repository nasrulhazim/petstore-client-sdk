...
class StoreApi(object):
    ...
    def delete_order_with_http_info(self, order_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'order_id' in local_var_params and local_var_params['order_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `order_id` when calling `delete_order`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_order_by_id_with_http_info(self, order_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'order_id' in local_var_params and local_var_params['order_id'] > 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `order_id` when calling `get_order_by_id`, must be a value less than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'order_id' in local_var_params and local_var_params['order_id'] < 1:  # noqa: E501
